    ...
    <div class="content-section detail-content">
      <el-row :gutter="20">
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
          ...
          <p class="comments">
            前端开发工程师,
            3年前端开发经验。主要从事PC端web页面开发，能够独立创建中小型web前端应用项目。注重开发效率，开发可高度复用的组件。不断学习新技术，敢于挑战。
            追求高质量代码，保证代码的可读性和可维护性；不断学习前端前沿技术，优化现有技术栈，力求最优解。
          </p>
          <p class="comments">
          ...
          <ul class="detail-list">
            <li class="points">
              ...
              >熟练掌握原生javascript的前端开发，应用 javascript 高级语法
              es6+,以逐步减少工具类库的使用。熟练运用jquery进行前端开发，掌握数据可视化
          ...
          <div class="message-inner">
            ...
            <div class="qa-message-content">
              ...
              <div class="qa-message-item">
                ...
                <div class="qa-info">
                  1.
                  开发PC端单页面应用；负责公司现DUI开发者平台系统的开发，对已有项目（产品系统、技能系统）和新项目（权限系统）的前端修改调试和开发工作；<br />
                  2.
                  ...
                  6.
                  公司内部ui组件库开发的发起人；负责公司内部组件库开发，全局功能开发；封装Axios对后端接口做异常处理和数据处理，及相关业务处理；推进前端工程化和自动化。<br />
                </div>
              </div>
            </div>
          </div>
